<?php
	...
	if ($total > 0) {	  
		while ($cert = mysql_fetch_array($qry)){
			...
			$corpo = '<p>Certificamos que <vb>'.$cert[0].'</vb> participou do <vb>XIII Encontro Maringaense de Biologia e XXVI Semana de Biologia</vb>, realizado de 05 de agosto a 09 de agosto de 2013 em Maringa-PR - Brasil, ministrando o minicurso <vb>'.$cert[1].'.</vb></p>';
