<div class="sidebar">
     ...
     <ul id="tabs">
         ...
         <li><a href="<?=BASE_URL?>/programacao.php" title="Programa&ccedil;&atilde;o">Programa&ccedil;&atilde;o Resumida</a></li>
         ...
         <li><a href="<?=BASE_URL?>/resumos.php">Instruções para Resumos</a></li>
         <li><a href="<?=BASE_URL?>/instrucoes-poster.php">Instru&ccedil;&otilde;es para exposição de poster</a></li>
...
<div style="height: 25px;"></div>
<a class="banner" href="#cpf_modal" title="Verifique sua insrição" data-toggle="modal">
 <img src="img/banners/verify-lateral.png"/>
</a>
